                    ...
                    <div className="task__body-card" onClick={() => {handleOpenTask(tarea)}}>
                        ...
                        <div className="task__body-card-details">
                            <div className="task__body-card-details-state">
                                {tarea.estado?<strong className='color-text-green'>Completada</strong>: !tarea.estado && moment(tarea.fechaTermino).isBefore(Date.now())?<strong className='color-text-orange'>Atrasada</strong>:<strong className='color-text-blue'>En proceso</strong>}
                            </div>
